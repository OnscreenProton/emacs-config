...
Finally, set Emacs to use aspell instead of ispell.
...
(cond (IS-WINDOWS (setq org-directory "c:/Users/onscr/Documents/org"))
      (t (setq org-directory "~/Documents/org")))
#+end_src
...
(cond (IS-WINDOWS (setq org-roam-directory "c:/Users/onscr/Documents/org/roam"))
      (t (setq org-roam-directory "~/Documents/org/roam")))
...
*****
** Calculator
Emacs ~calc~ is pretty handy, but there are a few things we can do to improve it.

*** Defaults

Use symbolic and radians.
#+begin_src emacs-lisp
...
Pulling from Tecosaur's Emacs config, CalcTeX looks pretty handy.
...
*** Casual-calc
I recently found [[https://github.com/kickingvegas/casual-calc][this package]] and thought it would be nice to have in my config.
#+begin_src emacs-lisp :tangle packages.el
(package! casual-calc)
#+end_src
...
(use-package! casual-calc
  :after calc
  :ensure nil)
(map! ;;:map +emacs-calculator
      :leader
      (:prefix-map ("v" . "Caulculator")
       :desc "Open Calc" "o" #'calc
       :desc "Calc Transient Menu" "t" #'casual-calc-tmenu))
#+end_src
